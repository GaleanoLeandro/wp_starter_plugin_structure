...
module.exports = {
	...
	// Project options.
	projectURL: 'dev.wp-plugins.com', // Local project URL of your already running WordPress site. Could be something like PP.local or localhost:3000 depending upon your local WordPress setup.
	...
	imgDST: './src/img/', // Destination folder of optimized images. Must be different from the imagesSRC folder.
